...
class ParentWindow(QMainWindow):
	...
	def __init__(self, parent = None):
		...
		logger.info('*                                                                                                                  *')
		logger.info('*                                                   BY:                                                            *')
		logger.info('*                                             BISHAL BUDHATHOKI                                                    *')
		logger.info('*                                             BIPLOVE SHAKYA                                                       *')
		logger.info('*                                             SHEKHAR PALIT                                                        *')
		logger.info('*                              Department of Computer Science & Engineering                                        *')
		logger.info('*                                                                                                                  *')
		logger.info('*                                                  FOR:                                                            *')
		logger.info('*                                   S.J.C. Institute of Technology, SJCIT                                          *')
		logger.info('********************************************************************************************************************')
	...
	def setup_year_window(self):
		...
		depts = [ 'Computer Science & Engineering','Civil Engineering', 'Electronics & Communications Engineering',\
	...
	def setup_about_window(self):
		...
		self.ui_about.logoLabel.setPixmap(QtGui.QPixmap('wallpapers/2.png'))
	...
	def setup_license_window(self):
		...
		self.ui_license.logoLabel.setPixmap(QtGui.QPixmap('icons/2.png'))
